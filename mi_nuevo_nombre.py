...
# --- ESTILOS CSS PERSONALIZADOS (MONOCROMÁTICO NEGRO + TARJETA DERECHA TÁCTICA) ---
st.markdown("""
    <style>
        .stApp {
        ...
        /* CONTENEDOR TÁCTICO PANEL DERECHO */
        .right-panel-card {
...
# VALORES PRECONFIGURADOS POR PERFIL
PROFILE_PRESETS = {
...
# CÁLCULO DE INCERTIDUMBRE CON SCIPY
delta_h_cm = 0.05
