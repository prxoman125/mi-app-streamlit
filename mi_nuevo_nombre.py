...
# Configuración del maquetado base para Plotly 3D (Se agrega dragmode='pan')
PLOTLY_LAYOUT_BASE = dict(
    ...
    dragmode="pan"  # <-- Modo de arrastre directo por defecto (sin zoom en cruz)
)

# Configuración adicional de la barra de Plotly en Streamlit
PLOTLY_CONFIG = {
    'scrollZoom': True,  # Permite zoom suave solo con la rueda del mouse
    'displayModeBar': True,
    'modeBarButtonsToRemove': ['select2d', 'lasso2d'] # Remueve herramientas incomodas de selección
}
