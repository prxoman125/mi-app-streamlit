...
# Evaluamos primero la licencia para que sus variables afecten el cálculo principal si está activa
with st.sidebar:
    ...
    if usuario_pago:
        ...
        inflacion_premium = 4.5  # Valor base por defecto
        impuesto_premium = 0     # Sin impuestos en versión libre
        volatilidad_premium = 0  # Sin volatilidad en versión libre
...
with col2:
    ...
    if calcular:
        ...
        # Cálculo de la proyección anual estándar
        ...
        # Aplicación de impuestos si el usuario es premium
...
if not usuario_pago:
    ...
    if not df_financiero.empty:
        ...
        with p_col1:
            ...
            st.write("Análisis estocástico de 500 escenarios independientes simulando volatilidad real:")
            
            # Algoritmo de Montecarlo usando NumPy
            simulaciones = 500
            resultados_finales = []
            ...
            # Visualización elegante del riesgo con un histograma de Plotly
        ...
        with p_col2:
            ...
            # Bloque analítico de desglose fiscal explicativo
